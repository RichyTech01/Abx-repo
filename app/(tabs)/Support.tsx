    ...
    <ScreenWrapper>
      ...
      <View className="mx-[20px] mt-[24px]  ">
        <UrbanistText className="text-[16px] leading-[22px] text-center mx-auto text-[#2D2220]">
          At ABX, we are committed to ensuring that all your needs are met with
          efficiency, care, and professionalism. Our dedicated support team is
          always ready to answer your questions, provide technical guidance, or
        ...
        <View className="mt-[22px] gap-[16px]  ">
          ...
          <View className="bg-[#FDF0DC] rounded-[8px] py-[13px] w-full  items-center ">
            <View className=" w-[70%] items-center ">
              <ChatwithRepIcon />
              <OreAppText className="text-[16px] leading-[20px] text-[#2C2C2C]  mt-[16px] ">
                Send an email
          ...
          <View className="bg-[#FDE2F6] rounded-[8px] py-[13px] w-full  items-center ">
            <View className=" w-[70%] items-center ">
              <ChatwithRepIcon />
              <OreAppText className="text-[16px] leading-[20px] text-[#2C2C2C]  mt-[16px] ">
                Call us
