...
export default function Transactioncard({TotalAmount, DatePlaced, OrderNumber }: TransactioncardProps ) {
  return (
    <View className="bg-white border border-[#E5E7EB] rounded-[8px] px-[14.5px] py-[11px] flex-row items-center justify-between gap-2">
