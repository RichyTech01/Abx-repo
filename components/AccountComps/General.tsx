  ...
  return (
    <View className="mt-[24px]   ">
      ...
      <View className="border border-[#F1EAE7] rounded-[8px] py-[10px px-[8px] bg-white mt-[18px] " >
        <TouchableOpacity className="py-[10px] pl-[4px] border-b border-[#F1EAE7] flex-row items-center justify-between " onPress={() => router.push("/Screens/AccountScreen/AllStore")}>
        ...
        <TouchableOpacity className="py-[10px] pl-[4px] border-b border-[#F1EAE7] flex-row items-center justify-between " onPress={() => router.push("/Screens/AccountScreen/FavouriteStore")}>
          <View className="flex-row items-center ">
            <FavoriterIcon />
            <Text className="font-urbanist-medium text-[#2D2220] text-[14px] leading-[20px] ml-[8px]  ">
              Favorite stores
